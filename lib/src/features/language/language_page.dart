...
class _LanguageTranslatorScreenState extends State<LanguageTranslatorScreen> {
  ...
  void initState() {
    ...
    if (widget.initialTargetLang != null)
      _targetLang = widget.initialTargetLang!;
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(item['target']!,
                            style: const TextStyle(
                                color: AppColors.pine, fontSize: 15)),
  ...
  Widget build(BuildContext context) {
    ...
    const backgroundColor = AppColors.blush;
    const primaryGreen = AppColors.pine;
                          ...
                          AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  AppColors.pine.withAlpha(35),
                                  AppColors.pine.withAlpha(15),
                                ],
                              ),
                              borderRadius: BorderRadius.circular(16),
                              border: Border.all(
                                color: AppColors.pine.withAlpha(140),
                                width: 1.3,
                              ),
                              boxShadow: [
                                BoxShadow(
                                  color: AppColors.pine.withAlpha(20),
                                  blurRadius: 10,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(
                                          color: AppColors.pine.withAlpha(80),
                                          blurRadius: 6,
  ...
  Widget _buildActionIcon(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Icon(
          icon,
          color: isHighlighted ? Colors.redAccent : AppColors.pine,
          size: 22,
        ),
      ),
    );
